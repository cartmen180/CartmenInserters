data:extend({
  { type = "item", name = "long-inserter-left",
    icon = "__CartmenInserters__/graphics/icons/long-handed-inserter-left.png",
    flags = {"goes-to-quickbar"},
    subgroup = "inserter",
    order = "c[long-inserter-left]",
    place_result = "long-inserter-left",
    stack_size = 50
  },
  { type = "item", name = "long-inserter-right",
    icon = "__CartmenInserters__/graphics/icons/long-handed-inserter-right.png",
    flags = {"goes-to-quickbar"},
    subgroup = "inserter",
    order = "c[long-inserter-right]",
    place_result = "long-inserter-right",
    stack_size = 50
  },
  { type = "item", name = "long-inserter-half",
    icon = "__CartmenInserters__/graphics/icons/long-handed-inserter-half.png",
    flags = {"goes-to-quickbar"},
    subgroup = "inserter",
    order = "c[long-inserter-half]",

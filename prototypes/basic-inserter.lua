data:extend({
  { type = "item", name = "basic-inserter-left",
    icon = "__CartmenInserters__/graphics/icons/basic-inserter-left.png",
    flags = {"goes-to-quickbar"},
    subgroup = "inserter",
    order = "b[basic-inserter-left]",
    place_result = "basic-inserter-left",
    stack_size = 50
  },
  { type = "item", name = "basic-inserter-right",
    icon = "__CartmenInserters__/graphics/icons/basic-inserter-right.png",
    flags = {"goes-to-quickbar"},
    subgroup = "inserter",
    order = "b[basic-inserter-right]",
    place_result = "basic-inserter-right",
    stack_size = 50
  },
  { type = "item", name = "basic-inserter-half",
    icon = "__CartmenInserters__/graphics/icons/basic-inserter-half.png",
    flags = {"goes-to-quickbar"},
    subgroup = "inserter",
    order = "b[basic-inserter-half]",
